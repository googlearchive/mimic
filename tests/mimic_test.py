...
class MimicTest(unittest.TestCase):
  ...
  def setUp(self):
    ...
    mimic._most_recent_query_string_project_id = None
  ...
  def testGetProjectIdFromPathInfo(self):
    ...
    self.assertEquals(None, mimic.GetProjectIdFromPathInfo('/'))
    self.assertEquals('foo', mimic.GetProjectIdFromPathInfo('/_mimic/p/foo/'))
    self.assertEquals(None, mimic.GetProjectIdFromPathInfo('/_mimic/p/foo'))
  ...
  def CheckProjectId(self, expected_value, header_value, path_info_value,
    ...
    mimic._most_recent_query_string_project_id = recent_query_value or None
