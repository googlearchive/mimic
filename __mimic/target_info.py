...
# Match devappserver behavior of no caching, rather than production default
# https://developers.google.com/appengine/docs/python/config/appconfig#Static_Cache_Expiration
_DEFAULT_STATIC_FILE_EXPIRATION = '0s'
